      ...
      <main className="relative z-10">
        <section className="px-6 lg:px-12 pt-16 pb-24 max-w-7xl mx-auto">
          <div className="flex flex-col items-center text-center">
            ...
            >
              Join Ai Academy and learn from expertly crafted courses, modules,
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              >
                ...
                <div className="mt-8">
                  <Link href={plan.tier === "Free" ? "/dashboard" : "/pricing"}>
                    <Button
                      ...
                      className={`w-full ${
                        plan.popular
                          ...
                          : "border-zinc-700 bg-white/5 hover:bg-white/10 text-white"
                      }`}
                    >
            ...
            {[
              {
                ...
                content:
                  "Ai's teaching style is incredible. I went from knowing nothing to landing my first dev job in 6 months!",
                avatar: "🧑‍💻",
              },
              {
                name: "Sarah Miller",
