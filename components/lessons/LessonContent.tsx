    ...
    return (
      <div className="prose prose-invert max-w-none mt-8">
        <h2 className="text-2xl font-bold mt-6 mb-3 text-white">
          Session 1: Basics of {title || "this lesson"}
        </h2>
        <p className="text-zinc-300 leading-relaxed mb-4">
          Welcome to this lesson! In this session, we will cover the
          foundational concepts and the basics of {title || "the topic"}. Please
          refer to the video for a detailed walkthrough.
        </p>
        <h2 className="text-2xl font-bold mt-6 mb-3 text-white">
          Session 2: Deep Dive into {title || "this lesson"}
        </h2>
        <p className="text-zinc-300 leading-relaxed mb-4">
          Now that you understand the basics, let's explore more advanced topics
          and practical applications of this theory.
        </p>
      </div>
    );
  }
